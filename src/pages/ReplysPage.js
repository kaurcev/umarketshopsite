          ...
          <>
            {
             data.map((item) => (
              <div key={item.id} className="cart reply">
                ...
                {
                  item.reply === "" ? (<>
                 <p className='statcheck red'><i class="fa fa-times" aria-hidden="true"></i> Требует ответа</p>
                  </>) : (<>
                    <p className='statcheck'><i class="fa fa-check" aria-hidden="true"></i> Ответ дан</p>
                  </>)
                }
