  ...
  useEffect(() => {
    ...
    return (
      ...
      <main className='profile pay'>
        <div className='w250'>
        <Link className='bt' to='/profile/postav/replys'>Вернуться назад</Link>
        </div>
             ...
             </div>
              {
                data.reply ? (
                  ...
                  <form className='formgap' onSubmit={submitHandler} >
                    <label>Напишите свой ответ на отзыв пользователя, но обратите внимание, что ваш ответ будет виден всем</label>
                  <textarea type="text" value={message} onChange={reviewHandler}></textarea>
                  <p className='mini'>После отправки ответа на отзыв, вы не сможете его отредактировать</p>
                  <div className='duo'>
